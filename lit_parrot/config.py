...
pythia = {
    ...
    "mosaicml-mpt-7B-instruct" : dict(block_size=2048, n_head=32, n_layer=32),
}
...
redpajama_incite = {
    ...
    # "RedPajama-INCITE-{}-3B-v1": dict(block_size=2048, n_layer=32, n_embd=4096, n_head=32, padding_multiple=256, rotary_percentage=1.0, parallel_residual=False),
